...
namespace Lof\ProductNotification\Block\Adminhtml\Stock\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('productnotification_stock');

        if ($this->_isAllowedAction('Lof_ProductNotification::stock_edit')) {

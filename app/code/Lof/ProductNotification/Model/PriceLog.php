...
class PriceLog extends \Magento\Framework\Model\AbstractModel implements PriceInterface
{
    /**#@-*/
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'productnotification_price_log';

    /**
     * @var string
     */
    protected $_cacheTag = 'productnotification_price_log';
     ...
     * @var string
     */
    protected $_eventPrefix = 'productnotification_price_log';
     ...
     * @param ResourceModel\PriceLog|null $resource
     * @param ResourceModel\PriceLog\Collection|null $resourceCollection
    ...
    public function __construct(
        ...
        \Lof\ProductNotification\Model\ResourceModel\PriceLog $resource = null,
        \Lof\ProductNotification\Model\ResourceModel\PriceLog\Collection $resourceCollection = null,
    ...
    {
        $this->_init('Lof\ProductNotification\Model\ResourceModel\PriceLog');
    }

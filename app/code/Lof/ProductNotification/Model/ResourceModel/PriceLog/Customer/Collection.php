...
namespace Lof\ProductNotification\Model\ResourceModel\PriceLog\Customer;

class Collection extends \Lof\ProductNotification\Model\ResourceModel\Price\Customer\Collection
{
    /**
    ...
    {
        $this->getSelect()->join(
            ['alert' => $this->getTable('lof_product_notification_price_log')],

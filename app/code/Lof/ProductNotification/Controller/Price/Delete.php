...
namespace Lof\ProductNotification\Controller\Price;
...
class Delete extends \Lof\ProductNotification\Controller\AbstractIndex
{
    ...
    public function __construct(
        ...
        \Lof\ProductNotification\Model\ResourceModel\Price\CollectionFactory $priceCollectionFactory
        ) {
    ...
    public function execute()
    {
        ...
        if ($productId && $this->_customerSession->isLoggedIn()) {
            ...
            try {
                ...
                if ($product) {
                    $priceNotification = $this->_priceCollectionFactory->create()
                    ->addFieldToFilter('customer_id', $customerId)
                    ->addFieldToFilter('product_id', $productId)
                    ->getFirstItem();
                    if ($priceNotification->getProductId()==$productId) {

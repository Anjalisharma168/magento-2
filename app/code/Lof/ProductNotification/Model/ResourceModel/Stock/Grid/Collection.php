...
namespace Lof\ProductNotification\Model\ResourceModel\Stock\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\Search\AggregationInterface;
use Lof\ProductNotification\Model\ResourceModel\Stock\Collection as StockCollection;
...
class Collection extends StockCollection implements SearchResultInterface
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->joinLeft(
            ['ca' => $this->getTable('catalog_product_entity')],
            'main_table.product_id = ca.entity_id',
            ['sku']
        )->joinLeft(
            ['product_varchar' => $this->getTable('catalog_product_entity_varchar')],
            "main_table.product_id = product_varchar.entity_id AND product_varchar.attribute_id = $productNameAttributeId AND product_varchar.store_id =".(int)$default_store_id,
            ['product_name' => 'product_varchar.value']
        )->group(
            'main_table.alert_stock_id'
        );

...
namespace Lof\ProductNotification\Model\ResourceModel\StockLog\Customer;

class Collection extends \Lof\ProductNotification\Model\ResourceModel\Stock\Customer\Collection
{
    /**
    ...
    {
        $this->getSelect()->join(
            ['alert' => $this->getTable('lof_product_notification_stock_log')],

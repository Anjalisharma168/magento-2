...
class Stock extends \Lof\ProductNotification\Model\ResourceModel\AbstractResource {
    /**
    ...
    {
        $this->_init('lof_product_notification_stock', 'alert_stock_id');
    }
    ...
    {
        if (is_null($object->getId()) && $object->getProductId()) {
            if ($row = $this->_getAlertRow($object)) {
                $object->addData($row);
                throw new \Magento\Framework\Exception\LocalizedException(
                    __('You are already subscribed to this product.')
                );
            }
        }

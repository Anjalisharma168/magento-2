...
class Stock extends \Magento\Framework\Model\AbstractModel implements StockInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'productnotification_stock';

    /**
     * @var string
     */
    protected $_cacheTag = 'productnotification_stock';
     ...
     * @var string
     */
    protected $_eventPrefix = 'productnotification_stock';
     ...
     * @param ResourceModel\Stock|null $resource
     * @param ResourceModel\Stock\Collection|null $resourceCollection
    ...
    public function __construct(
        ...
        \Lof\ProductNotification\Model\ResourceModel\Stock $resource = null,
        \Lof\ProductNotification\Model\ResourceModel\Stock\Collection $resourceCollection = null,
    ...
    {
        $this->_init('Lof\ProductNotification\Model\ResourceModel\Stock');
    }
